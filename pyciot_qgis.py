...
class PyCIOT:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&PyCIOT-QGIS')

        # Check if plugin was started the first time in current QGIS session
        # Must be set in initGui() to survive plugin reloads
        self.toolbar = self.iface.addToolBar(u'PyCiotDownloader')
        self.toolbar.setObjectName(u'PyCiotDownloader')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PyCIOT', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/pyciot_qgis/icon.png'
        self.rectangleAction = self.add_action(
                                        icon_path,
                                        text=self.tr(u'Download PyCIOT data by rectangle selection'),
    ...
    def run(self, startX, startY, endX, endY):
        ...
        self.dlg = PyCIOTDialog(self.iface, startX, startY, endX, endY)
